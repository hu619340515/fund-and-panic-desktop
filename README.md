...
- [安装版 2.0.2](https://github.com/hu619340515/fund-and-panic-desktop/releases/download/v2.0.2/FundAndPanic-Setup-2.0.2-x64.exe)：可选安装目录、桌面和开始菜单快捷方式。
- [便携版 2.0.2](https://github.com/hu619340515/fund-and-panic-desktop/releases/download/v2.0.2/FundAndPanic-Portable-2.0.2-x64.exe)：直接双击运行，数据仍保存在用户目录。
- [版本与校验文件](https://github.com/hu619340515/fund-and-panic-desktop/releases/tag/v2.0.2)。安装包未购买代码签名证书，Windows 可能显示未知发布者；请从本仓库 Release 下载并核对 SHA-256。
...
```text
FundAndPanic-Setup-2.0.2-x64.exe
FundAndPanic-Portable-2.0.2-x64.exe
```
...
在“近一年收盘与历史估计”中点击“补全历史”，下载真实历史行情后逐日回算。绿色虚线为历史估计，明确显示覆盖率与缺项，蓝色为正式收盘；两者独立保存。详见 [2.0.2 说明](docs/release-notes-v2.0.2.md)。
